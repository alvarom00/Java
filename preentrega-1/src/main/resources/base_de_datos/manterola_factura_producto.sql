...
CREATE TABLE `factura_producto` (
  ...
  KEY `FKhuacwchsbjho5kd5qje7f7rah` (`producto_id`),
  KEY `FKfe820y2rkjf0b2rd6q2yxtgln` (`factura_id`),
  CONSTRAINT `FKfe820y2rkjf0b2rd6q2yxtgln` FOREIGN KEY (`factura_id`) REFERENCES `facturas` (`id`),
  CONSTRAINT `FKhuacwchsbjho5kd5qje7f7rah` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`)
